...
CREATE TABLE `admin_backup` (
  `idadmin_backup` int NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `admin_backup` WRITE;
/*!40000 ALTER TABLE `admin_backup` DISABLE KEYS */;
INSERT INTO `admin_backup` VALUES (1,'4','tt','tt','tt','tt','insert','valid'),(2,'5','ее','ее','ее','ее','insert','valid');
/*!40000 ALTER TABLE `admin_backup` ENABLE KEYS */;
UNLOCK TABLES;
