...
CREATE TABLE `users_backup` (
  `idusers_backup` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `users_backup` VALUES (1,'6','uu','uu','uu','uu','insert','valid'),(2,'1','e','e','e','e','update',''),(3,'2','g','g','g','g','update',''),(4,'3','m','m','m','m','update',''),(5,'4','geg','geg','geg','geg','update',''),(6,'5','gg','gg','gg','gg','update','');
