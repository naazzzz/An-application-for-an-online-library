...
INSERT INTO `admin` VALUES (1,'f','f','f','f','valid'),(2,'ge','ge','ge','ge','valid'),(4,'tt','tt','tt','tt','valid'),(5,'ее','ее','ее','ее','valid');
...
insert into admin_backup(idadmin,email,password,firstname,lastname,action,status)
values(new.idadmin,new.email,new.password,new.firstname,new.lastname,"insert","valid");
END */;;
DELIMITER ;
...
insert into admin_backup(idadmin,email,password,firstname,lastname,action,status)
values(new.idadmin,new.email,new.password,new.firstname,new.lastname,"update",old.status);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
