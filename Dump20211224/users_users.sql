...
INSERT INTO `users` VALUES (1,'e','e','e','e','valid'),(2,'g','g','g','g','valid'),(3,'m','m','m','m','valid'),(4,'geg','geg','geg','geg','valid'),(5,'gg','gg','gg','gg','valid'),(6,'uu','uu','uu','uu','valid');
...
insert into users_backup(idusers,email,password,firstname,lastname,action,status)
values(new.idusers,new.email,new.password,new.firstname,new.lastname,"insert","valid");
END */;;
DELIMITER ;
...
insert into users_backup(idusers,email,password,firstname,lastname,action,status)
values(new.idusers,new.email,new.password,new.firstname,new.lastname,"update",old.status);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
